...
infection_data <- get_deaths_per_federal_states(cov_data, date_start = "2020/01/01", date_end = "2021/08/09")
predict_future_progress(infection_data, future_days = 370)


```
```{r predict_future_progress Infektionen}
infection_data <- get_infections_per_federal_states(cov_data, date_start = "2020/01/01", date_end = "2021/08/09")
predict_future_progress(infection_data, future_days = 370)
```
