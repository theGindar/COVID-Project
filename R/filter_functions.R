...
#' Filtert nach EintrÃ¤gen im data frame, die zwischen dem spezifizierten Start- und Enddatum liegen.
#'
...
#' Erzeugt Daten zu TodesfÃ¤llen pro Bundesland
#'
#' @param data Data frame mit COVID-Daten
#' @param age_group_start String mit Startaltersgruppe (z. B. "A00")
#' @param age_group_end String mit Startaltersgruppe (z. B. "A59")
#' @param federal_state Einzelner String oder Vektor aus Strings mit angefragten BundeslÃ¤ndernamen
#' @param date_start Startdatum als String ("YYYY/MM/DD")
#' @param date_end Enddatum als String ("YYYY/MM/DD")
...
get_deaths_per_federal_states <- function(data, age_group_start = NA, age_group_end = NA, federal_state = NA, date_start = NA, date_end = NA) {
  ...
  federal_state <- gsub(pattern = "[ß]",replacement = "?Y", federal_state)
...
#' Erzeugt Daten zu TodesfÃ¤llen pro Landkreis
#'
#' @param data Data frame mit COVID-Daten
#' @param age_group_start String mit Startaltersgruppe (z. B. "A00")
#' @param age_group_end String mit Startaltersgruppe (z. B. "A59")
#' @param district Einzelner String oder Vektor aus Strings mit angefragten Landkreisnamen (beginnend mit z. B. "LK" fÃ¼r Landkreis und "SK" fÃ¼r Stadtkreis)
#' @param date_start Startdatum als String ("YYYY/MM/DD")
#' @param date_end Enddatum als String ("YYYY/MM/DD")
#' @return Data frame mit gesuchte Daten und beschreibendem Flag
#'
...
get_deaths_per_district <- function(data, age_group_start = NA, age_group_end = NA, district = NA, date_start = NA, date_end = NA){
  ...
  district <- gsub(pattern = "[ß]",replacement = "?Y", district)
...
#' Erzeugt Daten zu InfektionsfÃ¤llen pro Bundesland
#'
#' @param data Data frame mit COVID-Daten
#' @param age_group_start String mit Startaltersgruppe (z. B. "A00")
#' @param age_group_end String mit Startaltersgruppe (z. B. "A59")
...
#' Erzeugt Daten zu InfectionsfÃ¤llen pro Landkreis
#'
#' @param data Data frame mit COVID-Daten
#' @param age_group_start String mit Startaltersgruppe (z. B. "A00")
#' @param age_group_end String mit Startaltersgruppe (z. B. "A59")
...
#' Erzeugt Daten zu GenesenenfÃ¤llen pro Bundesland
#'
#' @param data Data frame mit COVID-Daten
#' @param age_group_start String mit Startaltersgruppe (z. B. "A00")
#' @param age_group_end String mit Startaltersgruppe (z. B. "A59")
...
#' Erzeugt Daten zu GenesenenfÃ¤llen pro Landkreis
#'
#' @param data Data frame mit COVID-Daten
#' @param age_group_start String mit Startaltersgruppe (z. B. "A00")
#' @param age_group_end String mit Startaltersgruppe (z. B. "A59")
...
#' FÃ¼gt Spalte "date_diff" an data frame an, welche die Anzahl Tage zwischen Infektion und Meldung beim Gesundheitsamt beschreibt.
#'
#' @param data Data frame mit COVID-Daten
#' @return Data frame mit gesuchte Daten und beschreibendem Flag
#'
...
#' Erzeugt Daten zu Fallsterblichkeit in ganz Deutschland abhÃ¤ngig von Altersgruppen
#'
#' @param data Data frame mit COVID-Daten
#' @param age_group_start String mit Startaltersgruppe (z. B. "A00")
#' @param age_group_end String mit Startaltersgruppe (z. B. "A59")
...
#' Erzeugt data frame bestehend aus "unsauberen" Daten, also Unklarheiten und fehlerhaften EintrÃ¤gen.
#'
#' @param data Data frame mit COVID-Daten
...
#' Reinigt data frame von "unsauberen" Daten, also Unklarheiten und fehlerhaften EintrÃ¤gen.
#'
#' @param data Data frame mit COVID-Daten
#' @return GesÃ¤ubertes data frame
#'
#' @examples
...
#' @param age_group_start String mit Startaltersgruppe (z. B. "A00")
#' @param age_group_end String mit Startaltersgruppe (z. B. "A59")
#' @param district Einzelner String oder Vektor aus Strings mit angefragten Landkreisnamen (beginnend mit z. B. "LK" fÃ¼r Landkreis und "SK" fÃ¼r Stadtkreis). Falls district NA ist werden Daten fÃ¼r alle Landkreise erzeugt.
#' @param date_start Startdatum als String ("YYYY/MM/DD")
#' @param date_end Enddatum als String ("YYYY/MM/DD")
#' @param incidence_days Zahl der Tage zur Berechnung der Inzidenz, z. B. incidence_days = 7 fÃ¼r 7-Tage-Inzidenz
#' @return Data frame mit gesuchte Daten
#'
#' @examples
...
#' Erzeugt data frame, welches die Correlation zwischen Landkreispaaren bezÃ¼glich derer Inzidenz beschreibt
#'
